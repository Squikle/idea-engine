...
public sealed class StatusRendererTests
{
    ...
    public void RenderLive_WithNextCycle_ShowsRelativeWait()
    {
        ...
        var text = StatusRenderer.RenderLive("Idle", "last cycle: +96 items", next, StartedAt, Now, TimeZoneInfo.Utc);
    ...
    {
        var text = StatusRenderer.RenderLive("Collecting", "FourChan…", null, StartedAt, Now, TimeZoneInfo.Utc);
    ...
    {
        var text = StatusRenderer.RenderLive("Idle", "<script>alert(1)</script>", null, StartedAt, Now, TimeZoneInfo.Utc);
    ...
    {
        var text = StatusRenderer.RenderOffline("crashed: FormatException", Now, TimeZoneInfo.Utc);
    ...
    {
        var text = StatusRenderer.RenderLive("Idle", null, Now.AddMinutes(-5), StartedAt, Now, TimeZoneInfo.Utc);
