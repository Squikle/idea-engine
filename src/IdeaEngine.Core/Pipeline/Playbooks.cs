...
public static class Playbooks
{
    ...
    [
        ...
        new("apifirst", "🔌", "API/MCP-first, sell shovels",
            "During a gold rush, sell shovels; stay upstream and be the man in the middle (Airbnb owns no apartments, Uber owns no cars). Package data, tools or capabilities as an API/MCP endpoint for AI agents and vibe-coders instead of building the end-user app. Expensive incumbent APIs (X at $200+/mo) are demand PROOF, not a wall - underprice them or serve the niche they ignore. Our own pain (paying for good signal sources) is the market's pain."),
